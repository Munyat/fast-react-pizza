...
function Order() {
  ...
  return (
    <div className="space-y-8 px-4 py-6">
      ...
      <div className="flex flex-wrap items-baseline justify-between gap-2 bg-stone-200 px-6 py-5">
      ...
      <div className="space-y-2 bg-stone-200 px-6 py-5">
        <p className="tetx-sm font-medium text-stone-600">
